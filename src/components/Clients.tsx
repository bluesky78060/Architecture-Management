        ...
        if (supabase !== null && supabase !== undefined) {
          ...
          const { data, error } = await supabase
            ...
            .insert({
              ...
              mobile: (payload.mobile !== '' && payload.mobile !== null && payload.mobile !== undefined) ? payload.mobile : '',
              contact_person: payload.type === 'PERSON' ? (payload.name !== '' && payload.name !== null && payload.name !== undefined ? payload.name : '') : (payload.business?.representative !== '' && payload.business?.representative !== null && payload.business?.representative !== undefined ? payload.business.representative : ''),
              type: (payload.type !== null && payload.type !== undefined) ? payload.type : 'BUSINESS',
              notes: (payload.notes !== '' && payload.notes !== null && payload.notes !== undefined) ? payload.notes : '',
