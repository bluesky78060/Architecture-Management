...
export default function StatsCards({ filteredWorkItems, format, getLaborCost }: Props) {
  ...
  const totalAmount = filteredWorkItems.reduce((sum, item) => sum + ((item.defaultPrice || 0) * (item.quantity || 1)) + getLaborCost(item), 0);
      ...
      <div className="bg-blue-100 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow border border-gray-100">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <p className="text-xs font-medium text-gray-600 mb-2">총 작업 항목</p>
      ...
      <div className="bg-green-100 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow border border-gray-100">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-base font-bold text-gray-900">{completed}건</p>
          </div>
      ...
      <div className="bg-purple-100 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow border border-gray-100">
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-base font-bold text-gray-900">{inProgress}건</p>
          </div>
