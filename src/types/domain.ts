...
export interface EstimateStatistics {
  ...
  approvedAmount: CurrencyAmount;
  reviewingCount: number;
  reviewingAmount: CurrencyAmount;
...
export interface Statistics {
  ...
  estimates?: EstimateStatistics;
  workItems?: WorkItemStatistics;
  period?: {
    from: DateString;
    to: DateString;
  };
